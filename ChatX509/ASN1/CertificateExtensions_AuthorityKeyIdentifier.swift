...
@usableFromInline struct CertificateExtensions_AuthorityKeyIdentifier: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(keyIdentifier: CertificateExtensions_KeyIdentifier?, authorityCertIssuer: PKIX1Implicit88_GeneralNames?, authorityCertSerialNumber: ArraySlice<UInt8>?) {
