...
@usableFromInline struct CertificateExtensions_CertificateListAssertion: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(issuer: InformationFramework_Name?, minCRLNumber: CertificateExtensions_CRLNumber?, maxCRLNumber: CertificateExtensions_CRLNumber?, reasonFlags: CertificateExtensions_ReasonFlags?, dateAndTime: AuthenticationFramework_Time?, distributionPoint: CertificateExtensions_DistributionPointName?) {
        self.issuer = issuer
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            var issuer: InformationFramework_Name? = nil
var peek_issuer = nodes
if let next = peek_issuer.next(), next.identifier == InformationFramework_Name.defaultIdentifier {
    issuer = try InformationFramework_Name(derEncoded: &nodes)
}
