...
@usableFromInline struct CHAT_Message: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            let feed_id: CHAT_Message_feed_id_Choice = try CHAT_Message_feed_id_Choice(derEncoded: &nodes)
            ...
            let files: [CHAT_FileDesc] = try DER.sequence(of: CHAT_FileDesc.self, identifier: .sequence, nodes: &nodes)
            let type: CHAT_MessageType = try CHAT_MessageType(derEncoded: &nodes)
            ...
            let status: CHAT_MessageStatus = try CHAT_MessageStatus(derEncoded: &nodes)
