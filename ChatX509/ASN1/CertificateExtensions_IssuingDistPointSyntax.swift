...
@usableFromInline struct CertificateExtensions_IssuingDistPointSyntax: DERImplicitlyTaggable, Sendable {
    ...
    @usableFromInline var onlySomeReasons: CertificateExtensions_ReasonFlags?
    @usableFromInline var indirectCRL: Bool?
    @inlinable init(distributionPoint: CertificateExtensions_DistributionPointName?, onlyContainsUserCerts: Bool?, onlyContainsCACerts: Bool?, onlySomeReasons: CertificateExtensions_ReasonFlags?, indirectCRL: Bool?) {
