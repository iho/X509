...
@usableFromInline struct ANSI_X9_62_SpecifiedECDomain: DERImplicitlyTaggable, Sendable {
    ...
    @usableFromInline var fieldID: ANSI_X9_62_FieldID
    ...
    @inlinable init(version: ANSI_X9_62_SpecifiedECDomainVersion, fieldID: ANSI_X9_62_FieldID, curve: ANSI_X9_62_Curve, base: ANSI_X9_62_ECPoint, order: ArraySlice<UInt8>, cofactor: ArraySlice<UInt8>?, hash: ANSI_X9_62_HashAlgorithm?) {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            let fieldID: ANSI_X9_62_FieldID = try ANSI_X9_62_FieldID(derEncoded: &nodes)
