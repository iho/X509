...
@usableFromInline struct CMS_AES_CCM_and_AES_GCM_2009_GCMParameters: DERImplicitlyTaggable, Sendable {
    ...
    @inlinable init(derEncoded root: ASN1Node,
        ...
        self = try DER.sequence(root, identifier: identifier) { nodes in
            ...
            var aes_ICVlen: CMS_AES_CCM_and_AES_GCM_2009_AES_GCM_ICVlen? = nil
var peek_aes_ICVlen = nodes
if let next = peek_aes_ICVlen.next(), next.identifier == CMS_AES_CCM_and_AES_GCM_2009_AES_GCM_ICVlen.defaultIdentifier {
    aes_ICVlen = try CMS_AES_CCM_and_AES_GCM_2009_AES_GCM_ICVlen(derEncoded: &nodes)
}
